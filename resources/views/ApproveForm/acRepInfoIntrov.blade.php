...
#acRepInfoIntrov .actions {
  display: flex !important;
  justify-content: space-between !important;
}

/* Style for action buttons with !important */
#acRepInfoIntrov .actions button {
  background-color: #f30d45 !important;
...
#acRepInfoIntrov.actions button:hover {
  background-color: #0056b3 !important;
}

/* Style for approve cells with !important */
#acRepInfoIntrov .approve {
  font-weight: bold !important;
}

/* Style for alternate rows with !important */
#acRepInfoIntrov tbody tr:nth-child(even) {

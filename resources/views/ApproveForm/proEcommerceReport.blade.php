...
#proEcommerceReport.actions button:hover {
  background-color: #0056b3 !important;
}

/* Style for approve cells with !important */
#proEcommerceReport .approve {
  font-weight: bold !important;
}

/* Style for alternate rows with !important */
#proEcommerceReport tbody tr:nth-child(even) {
...
<table id="proEcommerceReport">
    ...
    <tbody>
@foreach ($proEcommerceReport as $user)

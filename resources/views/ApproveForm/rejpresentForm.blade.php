...
#rejPresentForm .actions {
  display: flex !important;
  justify-content: space-between !important;
}

/* Style for action buttons with !important */
#rejPresentForm .actions button {
  background-color: #f30d45 !important;
...
#rejPresentForm .actions button:hover {
  background-color: #0056b3 !important;
}

/* Style for approve cells with !important */
#rejPresentForm .approve {
  font-weight: bold !important;
}

/* Style for alternate rows with !important */
#rejPresentForm tbody tr:nth-child(even) {
  background-color: #f9f9f9 !important;
}

</style>
@section('content')
<table id="rejPresentForm">
    <thead>
    <tr>
        <th>ID</th>
        <th>Name</th>

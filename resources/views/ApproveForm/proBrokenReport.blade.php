...
#proBrokenReport .actions {
  display: flex !important;
  justify-content: space-between !important;
}

/* Style for action buttons with !important */
#proBrokenReport .actions button {
  background-color: #f30d45 !important;
...
#proBrokenReport.actions button:hover {
  background-color: #0056b3 !important;
}

/* Style for approve cells with !important */
#proBrokenReport .approve {
  font-weight: bold !important;
}

/* Style for alternate rows with !important */
#proBrokenReport tbody tr:nth-child(even) {

...
#acSubject.actions button:hover {
...
#acSubject tbody tr:nth-child(even) {
...
<div class="container mt-5">
    <form action="{{route('save_Ac_Subject')}}" method="post">
...
<table class="table table-bordered table-hover">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col"><label class="custom-category" for="type">Type</label></th>
      <th scope="col"></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td> <input type="text" name="subject_english" class="custom-name_en" id="name_en"></td>
      <td>    <select name="type" id="category">
    ...
    <form action="{{route('save_Ac_Subject')}}" method="post">
      ...
      @endif
        <div class="custom-file">
            ...
            <label class="custom-category" for="type">Type</label>

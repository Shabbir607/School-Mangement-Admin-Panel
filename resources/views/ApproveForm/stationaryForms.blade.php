...
#stationaryForms .actions {
  display: flex !important;
  justify-content: space-between !important;
}

/* Style for action buttons with !important */
#stationaryForms .actions button {
  background-color: #f30d45 !important;
...
#stationaryForms .actions button:hover {
  background-color: #0056b3 !important;
}

/* Style for approve cells with !important */
#stationaryForms .approve {
  font-weight: bold !important;
}

/* Style for alternate rows with !important */
#stationaryForms tbody tr:nth-child(even) {
  background-color: #f9f9f9 !important;
}

</style>
@section('content')
<table id="stationaryForms">
    <thead>
    <tr>
        <th>ID</th>
        <th>Name</th>

...
<!-- DataTables -->
<link rel="stylesheet" href="{{asset('dashboard-assets/src/css/skin_color.css')}}">
<link rel="stylesheet" href="{{asset('dashboard-assets/src/css/vendors_css.css')}}">

<!-- Theme style -->
<link rel="stylesheet" href="{{asset('dashboard-assets/src/css/style.css')}}">

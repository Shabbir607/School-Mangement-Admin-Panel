...
#acInfoAfter.actions button:hover {
...
#acInfoAfter tbody tr:nth-child(even) {
...
<div class="container mt-5">
    <form action="{{route('save_Ac_InfoAfter')}}" method="post">

...
#approvePresentForm .actions button:hover {
  background-color: #0056b3 !important;
}

/* Style for approve cells with !important */
#approvePresentForm .approve {
  font-weight: bold !important;
}

/* Style for alternate rows with !important */
#approvePresentForm tbody tr:nth-child(even) {
  background-color: #f9f9f9 !important;
}

</style>
@section('content')
<table id="approvePresentForm">
    <thead>
    <tr>
        <th>ID</th>
        <th>Name</th>
    ...
    <tbody>
@foreach ($approvepresent as $user)

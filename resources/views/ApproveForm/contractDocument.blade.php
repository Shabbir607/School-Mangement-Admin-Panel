...
#contractDocument .actions {
  display: flex !important;
  justify-content: space-between !important;
}

/* Style for action buttons with !important */
#contractDocument .actions button {
  background-color: #f30d45 !important;
...
#contractDocument.actions button:hover {
  background-color: #0056b3 !important;
}

/* Style for approve cells with !important */
#contractDocument .approve {
  font-weight: bold !important;
}

/* Style for alternate rows with !important */
#contractDocument tbody tr:nth-child(even) {
...
<table id="contractDocument">
    ...
    <tbody>
@foreach ($contractdocument as $user)

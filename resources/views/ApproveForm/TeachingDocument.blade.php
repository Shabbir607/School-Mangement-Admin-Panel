...
#WorkDocument.actions button:hover {
  background-color: #0056b3 !important;
}

/* Style for approve cells with !important */
#WorkDocument .approve {
  font-weight: bold !important;
}

/* Style for alternate rows with !important */
#WorkDocument tbody tr:nth-child(even) {
...
<table id="WorkDocument">
    <thead>
    <tr>
        <th>ID</th>
        <th>Name</th>
        <th>Teaching Lic</th>
        <th>Teaching Lic Expire</th>
    ...
    <tbody>
@foreach ($teahcingDocument as $user)
